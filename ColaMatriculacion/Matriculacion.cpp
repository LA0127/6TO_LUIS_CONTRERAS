...
void menu(){
	cout<<"MENU"<<endl
	    ...
	    <<"3.Salir del programa y guardar el archivo"<<endl
...
void archivo(Nodo *&frente, Nodo *&fin,ICO alumnos){
	ofstream archivo;
	archivo.open("alumnos",ios::out);//Se abre el archivo
	if (archivo.fail())
	{
		cout<<"No se pudo abrir el archivo";
		exit(1);
	}
	archivo<<cin.getline(alumnos.clave,20);
	archivo<<cin.getline(alumnos.nombre,20);
	archivo<<alumnos.calificacion;
